...
type Input struct {
	CorpId uint64 `json:"corpid" query:"corpid"           validate:"required,min=1"` //企业ID
}
...
func Main(cc echo.Context) error {
	...
	output.Data = outputData{
		CorpId:              corp.F_id,
		Name:                corp.F_name,
		Status:              corp.F_status,
		StatusStr:           (*t_corp_corporation.Status)(&corp.F_status).String(),
